...
export default function Projects({ setNameSection }) {
  return (
    <section
      style={{ zIndex: 5 }}
      onMouseEnter={() => setNameSection("Projects")}
      ...
      <div className="text-white w-full">
        ...
        <div className="test-white rounded-full w-[880px] h-[880px] main-circle-project mx-auto">
          <div className="w-fit relative flex items-center cursor-pointer group circle-item-1 mx-auto right-44">
          ...
          <div className="w-fit relative flex items-center cursor-pointer group circle-item-2 mx-auto right-0">
            <h2 className="absolute w-fit font-bold text-2xl  -translate-x-1/2 left-1/2 z-10">
              Youtube
            </h2>
            <img
          ...
          <div className="w-fit relative flex items-center cursor-pointer group circle-item-3 mx-auto my-10">
          ...
          <div className="w-fit relative flex items-center cursor-pointer group circle-item-4 mx-auto left-10">
          ...
          <div className="w-fit relative flex items-center cursor-pointer group circle-item-4 mx-auto left-44">
            <h2 className="absolute font-bold text-2xl -translate-x-1/2 left-1/2 z-10">
              ShopBox
            </h2>
            <img
